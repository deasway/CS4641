...
def wine():
    ...
    for i in range(2,10):
        ...
        kmeans = KMeans(i)
        kmeans.fit(x)
        y_cluster = kmeans.fit(x).predict(x)
        ...
        print str.format("{:<20}{:<20}{:<20}{:<20}{:<20}{:<20}{:<20}", kmeans.inertia_,completeness_score(y, y_cluster),
...
def bank():
    ...
    for i in range(2,10):
        ...
        print str.format("{:<20}{:<20}{:<20}{:<20}{:<20}{:<20}{:<20}", "Inertia",
                         "Completeness", "Homogeneity", "V-measure", "Adj Rand", "Adj Mutual","Silhouette")
        print str.format("{:<20}{:<20}{:<20}{:<20}{:<20}{:<20}{:<20}", kmeans.inertia_, completeness_score(y, y_cluster),
                         homogeneity_score(y,y_cluster), v_measure_score(y, y_cluster), adjusted_rand_score(y_cluster, y),
                         adjusted_mutual_info_score(y, y_cluster),
                         silhouette_score(x,y_cluster,sample_size=10000))
